      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16 items-start">
        ...
        <div className="md:col-span-3 space-y-4">
          ...
          <div className="flex flex-col space-y-3 text-xs font-medium text-brand-primary/80">
            ...
            <button onClick={() => setCurrentTab('dashboard')} className="hover:text-brand-secondary text-left transition-colors cursor-pointer hover:underline underline-offset-4 decoration-brand-secondary/40">
              User Dashboard
            </button>
          </div>
        </div>
